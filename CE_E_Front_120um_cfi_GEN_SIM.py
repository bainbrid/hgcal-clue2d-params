...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    ...
    PGunParameters = cms.PSet(
        ControlledByEta = cms.bool(True), # was False
        Delta = cms.double(10),
        FlatPtGeneration = cms.bool(False),
        MaxEta = cms.double(1.85), # was 2.7
        MaxPhi = cms.double(3.14159265359),
        MaxVarSpread = cms.bool(False),
        MinEta = cms.double(1.65), # was 1.7
        ...
        VarMax = cms.double(100.01), # was 200.
        VarMin = cms.double(99.99), # was 25.
